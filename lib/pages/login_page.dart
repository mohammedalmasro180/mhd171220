...
import 'package:loginn/api/api_service.dart';
import 'package:loginn/model/login_model.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  //final encrypted = crypto.StringCryptor(pass);

  //final key = rypto.MacMismatchException
                ...
                Container(
                  ...
                  child: Form(
                    ...
                    child: Column(
                     ...
                     //     initialValue: value md5.convert(utf8.encode(input)).toString(),
                          decoration: new InputDecoration(
                            hintText: "Password",
                            enabledBorder: UnderlineInputBorder(
                                borderSide: BorderSide(
